...
def prbs_main_ring_b(ring, run_id, apc, cpbf_master)
    ...
    prbs_test = prbs_test & test_prbs_micron_single_line_err_force(gen_micron_id=80, chk_micron_id=79, gen_micron_pcs=0, chk_micron_pcs=1, gen_pcs_status=0x0003, chk_pcs_status=0x0030, run_id_str=run_id)
...
def prbs_main_ring_d(ring, run_id, apc, cpbf_master)
   ...
   # # Test PRBS on ring D -hard codded with error force:
	...
	prbs_test = prbs_test & test_prbs_micron_single_line_err_force(gen_micron_id=123, chk_micron_id=122, gen_micron_pcs=0, chk_micron_pcs=1, gen_pcs_status=0x0023, chk_pcs_status=0x0032, run_id_str=run_id)
