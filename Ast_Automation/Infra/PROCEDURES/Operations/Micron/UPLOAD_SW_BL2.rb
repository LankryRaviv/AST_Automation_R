...
version = version_hash['pre_sw_bl2']
...
version = "#{version[:BOOT_L2_MAJOR]}.#{version[:BOOT_L2_MINOR]}.#{version[:BOOT_L2_PATCH]}"
res, status = micron.upload_sw(microns_list, image, pathBootl2, version, ARGV[1], out_file)
