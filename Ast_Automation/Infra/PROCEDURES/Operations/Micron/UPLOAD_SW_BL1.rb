...
version = version_hash['pre_sw_bl1']
...
version = "#{version[:BOOT_L1_MAJOR]}.#{version[:BOOT_L1_MINOR]}.#{version[:BOOT_L1_PATCH]}"
res, status = micron.upload_sw(microns_list, image, pathBootl1, version, ARGV[1], out_file)
