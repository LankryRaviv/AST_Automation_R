...
power_on, ring_list = power_on_ring_to_reduced(ring,apc, ARGV[1])
    ...
    #test_prbs_micron_single_line(gen_micron_id=61, chk_micron_id=62, gen_micron_pcs=1, chk_micron_pcs=0, gen_pcs_status=0x0030, chk_pcs_status=0x0023, run_id_str=RUN_ID)
    #test_prbs_micron_single_line(gen_micron_id=62, chk_micron_id=63, gen_micron_pcs=1, chk_micron_pcs=0, gen_pcs_status=0x0032, chk_pcs_status=0x0303, run_id_str=RUN_ID)
    #test_prbs_micron_single_line(gen_micron_id=63, chk_micron_id=77, gen_micron_pcs=2, chk_micron_pcs=3, gen_pcs_status=0x0302, chk_pcs_status=0x3200, run_id_str=RUN_ID)
    #test_prbs_micron_single_line(gen_micron_id=66, chk_micron_id=65, gen_micron_pcs=0, chk_micron_pcs=1, gen_pcs_status=0x0003, chk_pcs_status=0x0032, run_id_str=RUN_ID)
    #test_prbs_micron_single_line(gen_micron_id=65, chk_micron_id=64, gen_micron_pcs=0, chk_micron_pcs=1, gen_pcs_status=0x0023, chk_pcs_status=0x0230, run_id_str=RUN_ID)
    #test_prbs_micron_single_line(gen_micron_id=64, chk_micron_id=78, gen_micron_pcs=2, chk_micron_pcs=3, gen_pcs_status=0x0320, chk_pcs_status=0x3200, run_id_str=RUN_ID)
    #test_prbs_micron_single_line(gen_micron_id=75, chk_micron_id=76, gen_micron_pcs=1, chk_micron_pcs=0, gen_pcs_status=0x0030, chk_pcs_status=0x0203, run_id_str=RUN_ID)
    #test_prbs_micron_single_line(gen_micron_id=80, chk_micron_id=79, gen_micron_pcs=0, chk_micron_pcs=1, gen_pcs_status=0x0003, chk_pcs_status=0x0030, run_id_str=RUN_ID)
    #test_prbs_micron_single_line(gen_micron_id=89, chk_micron_id=90, gen_micron_pcs=1, chk_micron_pcs=0, gen_pcs_status=0x0030, chk_pcs_status=0x2023, run_id_str=RUN_ID)
    #test_prbs_micron_single_line(gen_micron_id=94, chk_micron_id=93, gen_micron_pcs=0, chk_micron_pcs=1, gen_pcs_status=0x0003, chk_pcs_status=0x2032, run_id_str=RUN_ID)
    #test_prbs_micron_single_line(gen_micron_id=103, chk_micron_id=104, gen_micron_pcs=1, chk_micron_pcs=0, gen_pcs_status=0x0030, chk_pcs_status=0x0223, run_id_str=RUN_ID)
    #test_prbs_micron_single_line(gen_micron_id=108, chk_micron_id=107, gen_micron_pcs=0, chk_micron_pcs=1, gen_pcs_status=0x0003, chk_pcs_status=0x0032, run_id_str=RUN_ID)
    #test_prbs_micron_single_line(gen_micron_id=117, chk_micron_id=118, gen_micron_pcs=1, chk_micron_pcs=0, gen_pcs_status=0x0030, chk_pcs_status=0x0003, run_id_str=RUN_ID)
    #test_prbs_micron_single_line(gen_micron_id=122, chk_micron_id=121, gen_micron_pcs=0, chk_micron_pcs=1, gen_pcs_status=0x0003, chk_pcs_status=0x0030, run_id_str=RUN_ID)
    #test_prbs_micron_single_line(gen_micron_id=131, chk_micron_id=132, gen_micron_pcs=1, chk_micron_pcs=0, gen_pcs_status=0x0030, chk_pcs_status=0x0023, run_id_str=RUN_ID)
    #test_prbs_micron_single_line(gen_micron_id=132, chk_micron_id=133, gen_micron_pcs=1, chk_micron_pcs=0, gen_pcs_status=0x0032, chk_pcs_status=0x0303, run_id_str=RUN_ID)
    #test_prbs_micron_single_line(gen_micron_id=133, chk_micron_id=119, gen_micron_pcs=3, chk_micron_pcs=2, gen_pcs_status=0x3002, chk_pcs_status=0x2300, run_id_str=RUN_ID)
    #test_prbs_micron_single_line(gen_micron_id=136, chk_micron_id=135, gen_micron_pcs=0, chk_micron_pcs=1, gen_pcs_status=0x0003, chk_pcs_status=0x0032, run_id_str=RUN_ID)
    #test_prbs_micron_single_line(gen_micron_id=135, chk_micron_id=134, gen_micron_pcs=0, chk_micron_pcs=1, gen_pcs_status=0x0023, chk_pcs_status=0x2030, run_id_str=RUN_ID)
    #test_prbs_micron_single_line(gen_micron_id=134, chk_micron_id=120, gen_micron_pcs=3, chk_micron_pcs=2, gen_pcs_status=0x3020, chk_pcs_status=0x2300, run_id_str=RUN_ID)
