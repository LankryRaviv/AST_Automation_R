...
@cpbf.test_complete_fpga_upload(micron_list=[4], file_id=25, link="MIC_HSL", entries_qty=13296,entry_size=1754,start_entry=1,end_entry=13296,period_ms=50,max_fu_duration=700)
